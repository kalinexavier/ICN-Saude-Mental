...
with st.sidebar:
    ...
    # Alerta customizado com a correção de cor "atropelando" o CSS geral
    st.markdown("""
        <div style="background-color: #FFFFFF; border: 2px solid #EB5E28; padding: 15px; border-radius: 10px;">
            <p style="color: #EB5E28 !important; font-weight: bold; margin: 0; font-size: 0.85rem; text-align: left;">
